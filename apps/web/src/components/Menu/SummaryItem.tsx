  ...
  return (
    <li>
      <Link
        href={link}
        title={title || name}
        className={`flex items-center justify-between px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors ${isSelected ? "bg-gray-200 dark:bg-gray-700 font-bold" : ""}`}
      >
        <span>{name}</span>
